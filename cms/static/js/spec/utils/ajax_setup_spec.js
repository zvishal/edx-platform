(function() {
    require([
        'jquery',
        'backbone',
        'js/utils/ajax_prefix',
        'common/js/spec_helpers/ajax_helpers',
        'jasmine-stealth',
        'jquery.cookie'
    ],
    function($, Backbone, ajaxSetup, AjaxHelpers) {
        ...
        describe('ajaxSetup helper', function() {
            beforeEach(function() {
        ...
        return describe('AJAX Errors', function() {
            ...
            it('successful AJAX request does not pop an error notification', function() {
                var server = AjaxHelpers.server(this, [200, {}, '']);
            ...
            it('AJAX request with error should pop an error notification', function() {
                var server = AjaxHelpers.server(this, [500, {}, '']);
