...
def courses(request):
    ...
    if settings.FEATURES.get('ENABLE_COURSE_DISCOVERY'):
        # Send empty list for courses because they will be generated by course discovery app
        return render_to_response("courseware/courses.html", {'courses': []})
    else:
        ...
        return render_to_response("courseware/courses.html", {'courses': courses_list})
